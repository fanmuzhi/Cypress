...
#===============================================================
TEST_LOG_PATH = "./118001_shopfloor/"
    ...
    for dut in capture_data.get_datas():
        if dut["TestResult"] == TEST_RESULT or TEST_RESULT == "ALL":
            ...
            if("Noise" in dut.keys()):
                #noise_list = dut["Noise"]
                #if(len(noise_list) != 22):
                #    print "Found wrong noise data \n"
            ...
            if("RawData" in dut.keys()):
                #rawdata_list = dut["RawData"]
                #if(len(rawdata_list) != 22):
                #    print "Found wrong rawdata data \n"
                #    print dut["SerialNumber"]
                #    print rawdata_list
