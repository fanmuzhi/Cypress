...
namespace CypressSemiconductor.ChinaManufacturingTest.TrackpadModuleTester
{
    public partial class MainForm : Form
    {
        ...
        private bool validateSerialNumber(string sn)
        {
            ...
            {
                r = new Regex("^[01]([0][0-9]|[1][0-9])([0][0-9][0-9])[0][01][0-9][0-9]([0][1-9]|[1][0-5])([0-4][0-9]|[5][0-3])[0-6][a-zA-Z0-9][a-zA-Z0-9][a-zA-Z0-9]([1-8]$|$)");

            }
            else if (textBoxSN.Text.Length == 20)
            {
                r = new Regex("^[01]([0][0-9]|[1][0-9])([0][0-9][0-9])[0][01][npNP][0-9][0-9]([0][1-9]|[1][0-5])([0-4][0-9]|[5][0-3])[0-6][a-zA-Z0-9][a-zA-Z0-9][a-zA-Z0-9]([1-8]$|$)");
