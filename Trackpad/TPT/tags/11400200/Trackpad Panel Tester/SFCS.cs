...
namespace CypressSemiconductor.ChinaManufacturingTest.TPT
{
    class SFCS
    {
        ...
        public bool SFCS_PermissonCheck(String SerialNumber, String Model, string OperatorID, String Station)
        {
            bool permisson = false;
            int permisson_info = SFCSconnection.Select_Cypress_Result(SerialNumber, Model, OperatorID, Station);
        ...
        public bool SFCS_UploadTestResult(String SerialNumber, String Model, string OperatorID, String ErrorCdoe, String TestLog, String TestResult, String Station)
        {
            bool resultUploaded = false;
            int upload_info = SFCSconnection.Save_Cypress_Result(SerialNumber, Model, OperatorID, ErrorCdoe, TestLog, TestResult, Station);
            switch (upload_info)
            { 
                case 0:
                    resultUploaded = true;
