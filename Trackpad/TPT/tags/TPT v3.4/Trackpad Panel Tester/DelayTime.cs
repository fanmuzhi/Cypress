...
namespace CypressSemiconductor.ChinaManufacturingTest.TPT
{
    class DelayTime
    {
        ...
        //power 
        public const int POWER_ON_DELAY = 500;
        ...
        //mpq
        public const int MPQ_INIT_DELAY = 500;
        public const int MPQ_APA_COMMAND_DELAY = 500;
        public const int MPQ_MTG_COMMAND_DELAY = 200;
        public const int CHECK_PROGRAMMING_STATUS = 500;
