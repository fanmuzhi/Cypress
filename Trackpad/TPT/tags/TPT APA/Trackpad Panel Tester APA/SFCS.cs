...
namespace CypressSemiconductor.ChinaManufacturingTest.AFT
{
    class SFCS
    {
        ...
        public bool SFCS_PermissonCheck(String SerialNumber, String Model, String Station)
        {
            bool permisson = false;
            int permisson_info = SFCSconnection.Select_Cypress_Result(SerialNumber, Model, Station);
            ...
            { 
                ...
                case 3:
                    permisson = false;
                    connect_error = "SFCS: "+SerialNumber.ToString() + " failed at AFT.";
                    break;
                case 4:
                    permisson = false;
        ...
        public bool SFCS_UploadTestResult(String SerialNumber, String Model, String ErrorCdoe, String TestLog, String TestResult, String Station)
        {
            bool resultUploaded = false;
            int upload_info = SFCSconnection.Save_Cypress_Result(SerialNumber, Model, ErrorCdoe, TestLog, TestResult, Station);
            switch (upload_info)
            { 
                case 0:
                    resultUploaded = true;
