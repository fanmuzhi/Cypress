...
namespace CypressSemiconductor.ChinaManufacturingTest.TPT
{
    ...
    //        public static string ScannerPort = "COM2";
        ...
        public class Option
        {
            ...
            public static string U2751AtxtAddr1 = "USB0::2391::15640::MY48250045::0::INSTR";
            public static string U2751AtxtAddr2 = "USB0::2391::15640::my48250146::0::INSTR";
        }
        ...
        //    Port.ScannerPort = ini.GetString("Port", "ScannerPortName", Port.ScannerPort);
            ...
            Option.U2751AtxtAddr1 = ini.GetString("Option", "U2751A1", Option.U2751AtxtAddr1);
            Option.U2751AtxtAddr2 = ini.GetString("Option", "U2751A2", Option.U2751AtxtAddr2);
        }
        ...
        public static void Write()
        {
         ...
         //   ini.WriteValue("Port", "ScannerPortName", Port.ScannerPort);
            ...
            ini.WriteValue("Option", "U2751A1", Option.U2751AtxtAddr1);
            ini.WriteValue("Option", "U2751A2", Option.U2751AtxtAddr2);
        }
    }
}
