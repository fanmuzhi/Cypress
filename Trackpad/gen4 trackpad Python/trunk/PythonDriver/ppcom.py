...
#                    self._writeMessage('ClosePort', msg, self.kWarning)
    ...
    def GetPower(self):
        ...
        try:
            ...
            dict['PowerSupplied'] = fPowerSupplied
            dict['PowerDetected'] = fPowerDetected
            dict['Vcom'] = Vcom
            dict['Vaux'] = Vaux
...
def main():
    ...
    bridge.SetVoltage(Voltages.VOLT_50V)
    ...
    bridge.SetI2CPins(pins=I2CPins.kISSPPins97)
    bridge.PrintMessages()
    
    # Set the I2C speed
    bridge.SetI2CSpeed(enumI2Cspeed.CLK_1000K)
    bridge.PrintMessages()
