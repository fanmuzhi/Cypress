...
from PythonDriver import trackpadDriver
...
def currentTest():
    ...
    trackpad=trackpadDriver.trackpadDevice()
    ...
    try:
        ...
        returnData['ErrorMessage']=str(ex)
        returnData['TestResult']='Fail'
        print jsonReturn
        return jsonReturn
    ...
    trackpad.ExitBootloaderMode()
    
    
    #enter Sys info mode    
    #trackpad.WriteI2CData(0x00, [0x98]) 
    sleep(0.1)    
    trackpad.WriteI2CData(0x83)
    #sleep(0.5)
    datain=trackpad.ReadI2CData(0x00, 50)
    print datain
